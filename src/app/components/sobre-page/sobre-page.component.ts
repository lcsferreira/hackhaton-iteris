...
export class SobrePageComponent implements OnInit {
  ...
  public descricao = 'Somos uma página de apoio a mulher. Aqui você encontrará informações de instituições públicas dispostas a ajudar. Sinta-se acolhida por nós!';
